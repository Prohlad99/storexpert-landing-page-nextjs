      ...
      <div className="border-b border-white/15 relative overflow-hidden">
        <div className="container mx-auto max-w-[1344px]">
          ...
          >
            ...
            >
              Don&apos;t want to deal with technical stuff? Let us fire up Uvodo
              for you, so you can spend your time selling right away.
            </Paragraph>
            <MainButton style="w-full sm:w-9/12 sm:w-fit lg:w-fit hover:bg-blue-500 hover:border-white hover:text-white transition-all duration-200 ease-in">
              CONTACT US
            </MainButton>
          </motion.section>
        </div>
        ...
        <motion.img
          ...
          src="/assets/images/eclipse-1.svg"
          alt="eclipse"
        />
        <motion.img
          initial="hidden"
          ...
          src="/assets/images/eclipse-2.svg"
          alt="eclipse"
        />
      </div>
      {/* Footer */}
        ...
        <div className="px-5 py-10 flex flex-col sm:px-10 lg:grid grid-cols-3 lg:gap-y-32">
          ...
          <div className="text-center lg:col-span-3 md:flex justify-between items-center">
            <div className="flex items-center justify-center gap-4 mb-4 order-2">
              <a href="#">
                <img
                  className="w-8 h-auto object-cover opacity-70 hover:opacity-100 transition-all duration-200 ease-in"
